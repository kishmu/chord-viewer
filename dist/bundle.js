...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sheet__ = __webpack_require__(2);
...
let loadSheet = (evt) => {
  ...
  let sheet = window.sheet = new __WEBPACK_IMPORTED_MODULE_0__sheet__["a" /* default */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__transposer__ = __webpack_require__(3);
...
class Sheet {
  ...
  parse(sheet) {
    let parts = [];
    let song = sheet.split(__WEBPACK_IMPORTED_MODULE_0__consts__["a" /* default */].RE.SECTIONS).map(item => item.trim()); // ['...', 'intro 1:', '...', 'verse 1':, '...']
  ...
  parseHeader(header) {
    ...
    this.key = firstLine[1].match(__WEBPACK_IMPORTED_MODULE_0__consts__["a" /* default */].RE.CHORD)[0];
    if (!this.key) {
  ...
  transpose(newKey) {
    ...
    let transposer = new __WEBPACK_IMPORTED_MODULE_1__transposer__["a" /* default */](this.key, newKey);
    ...
    newSheet.parts = this.parts.map(([part, lines]) => {
      let transposedLines = lines.map(([lyric, chords]) => {
        let transposedChords = chords.replace(__WEBPACK_IMPORTED_MODULE_0__consts__["a" /* default */].RE.CHORD, (chord) => {
  ...
  toHtml() {
    let out = `<div class="header">
                <p>
                 <span class="song-name">${__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.escape(this.songName)}</span>
                 <span> - <span>
                 <span class="key">${__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.escape(this.key)}</span>
                 <span> - <span>
                 <span class="time-signature">${__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.escape(this.timeSignature)}</span>
                </p>
                <p class="movie">movie: ${__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.escape(this.movie ? this.movie : '')}</p>                 
              </div>`;
    this.parts.forEach(([part, lines]) => {
      let partHtml = '';
      partHtml += `<p class="part-name">${__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.escape(part)}</p>`;
      lines.forEach(([lyric, chords]) => {
        partHtml += `<p class="line">
                      <span class="lyric">${__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.escape(lyric)}  </span>
                      <span class="chords">${__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.escape(chords)}</span>
                     </p>`;
      });
...
class Transposer {
  ...
  getNew(oldChord) {
    ...
    return oldChord.replace(chordRoot, this.keyLookup[(__WEBPACK_IMPORTED_MODULE_0__consts__["a" /* default */].SYMBOL2NUM[chordRoot] + this.semitones) % 12]);
  }
}

/* harmony default export */ __webpack_exports__["a"] = (Transposer);
